  ...
  "data": [
    {
      "id": 1,
      "title": "系统维护通知",
      "content": "系统将于2024年1月1日进行维护，请提前做好准备。",
      "isActive": true,
      "createdAt": "2024-01-01T00:00:00.000Z",
      "updatedAt": "2024-01-01T00:00:00.000Z"
    }
  ...
  "data": [
    {
      "id": 1,
      "title": "新年活动",
      "imageUrl": "/uploads/banner1.png",
      "linkUrl": "/pages/activity/new-year",
      "order": 1,
      "isActive": true,
      "createdAt": "2024-01-01T00:00:00.000Z",
      "updatedAt": "2024-01-01T00:00:00.000Z"
...
| 参数名 | 类型 | 必填 | 描述 |
|-------|------|------|------|
| id | number | 是 | BannerID (路径参数) |
| title | string | 否 | Banner标题 |
| imageUrl | string | 否 | Banner图片URL |
| linkUrl | string | 否 | Banner链接URL |
| order | number | 否 | 排序序号 |
| isActive | boolean | 否 | 是否激活 |
...
│   ├── announcementController.js  # 公告相关控制器
│   └── bannerController.js   # Banner相关控制器
├── middleware/           # 中间件
│   └── auth.js               # 认证中间件
├── models/               # 数据模型
│   ├── User.js               # 用户模型
...
│   ├── announcementRoutes.js  # 公告相关路由
│   └── bannerRoutes.js       # Banner相关路由
├── uploads/              # 上传文件存储目录
└── utils/                # 工具函数
    └── database.js           # 数据库连接
```